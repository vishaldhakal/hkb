...
export const ngrokapi = 'https://admin.hikingbees.com';
...
export const SOCIAL_LINKS = {
  facebook: 'https://www.facebook.com/profile.php?id=100088960957931',
  instagram: 'https://www.instagram.com/hiking_bees/',
  email: 'beeshiking@gmail.com',
};
