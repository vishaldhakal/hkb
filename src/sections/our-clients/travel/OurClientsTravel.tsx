      ...
      <Container>
        ...
        >
          ...
          <Typography sx={{ color: 'text.secondary' }}>
            ...
            services to our clients. From experienced local guides to top-notch gear providers, our
            partnerships ensure that our clients have the support they need to make the most of
            their journey. Join us on a journey of discovery and experience the beauty of the
